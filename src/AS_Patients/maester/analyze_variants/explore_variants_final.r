...
## Load Config file
config <- yaml.load_file(find_config(), eval.expr=TRUE)

# 115 - FINAL FIGURES ################################################################################################
## VARIANT TABLES 115 ###############################################################################################
tabla_variantes_path <- config$explore_variants$variants_table_path
plot_dir <-  config$explore_variants$output_plots_variants_path
patient <- config$explore_variants$analysis_1$patient
samples <- config$explore_variants$analysis_1$samples
...
minimum_clone_size <- config$explore_variants$informative_variants_parameters$minimum_clone_size
minimum_vaf <- config$explore_variants$informative_variants_parameters$minimum_vaf 
vaf_2 <- config$explore_variants$informative_variants_parameters$vaf_2 
popul_percent <- config$explore_variants$informative_variants_parameters$popul_percent 
...
## SEURAT 115 E2 + S2 ##################################################################################################
datos_seurat_path <- config$explore_variants$input_sc_seurat_data
...
ggsave(paste0(config$explore_variants$output_plots_path,"/umaps_", patient,"/umap_115_cell_type.png"), plot = dimplot_115_post, width = 11, height = 9, dpi = 300)
...
trazado_115_E2 <- read.csv(config$explore_variants$analysis_1$input_trace_E2_table, sep = ";")
trazado_115_S2 <- read.csv(config$explore_variants$analysis_1$input_trace_S2_table, sep = ";")
...
ggsave(paste0(config$explore_variants$output_plots_path,"/umaps_", patient,"/umap_115_variants.png"), plot = umap_custom, width = 11, height = 9, dpi = 300)

# 109 - FINAL FIGURES ################################################################################################
## VARIANT TABLES 109 #############################################################################################
tabla_variantes_path <- config$explore_variants$variants_table_path
plot_dir <-  config$explore_variants$output_plots_variants_path
patient <- config$explore_variants$analysis_2$patient
samples <- config$explore_variants$analysis_2$samples
...
ggsave(paste0(config$explore_variants$output_plots_path,"/umaps_", patient,"/umap_109_cell_type.png"), plot = dimplot_109_post, width = 11, height = 9, dpi = 300)
...
# trazado_109_E2 <- read.csv(config$explore_variants$analysis_2$input_trace_E2_table, sep = ";")
trazado_109_S2 <- read.csv(config$explore_variants$analysis_2$input_trace_S2_table, sep = ";")
...
ggsave(paste0(config$explore_variants$output_plots_path,"/umaps_", patient,"/umap_109_variants.png"), plot = umap_custom, width = 11, height = 9, dpi = 300)

# 107 - FINAL FIGURES ################################################################################################
## VARIANT TABLES 107 #############################################################################################
tabla_variantes_path <- config$explore_variants$variants_table_path
plot_dir <-  config$explore_variants$output_plots_variants_path
patient <- config$explore_variants$analysis_3$patient
samples <- config$explore_variants$analysis_3$samples
...
ggsave(paste0(config$explore_variants$output_plots_path,"/umaps_", patient,"/umap_107_cell_type.png"), plot = dimplot_107_post, width = 11, height = 9, dpi = 300)
...
trazado_107_E2 <- read.csv(config$explore_variants$analysis_3$input_trace_E2_table, sep = ";")
trazado_107_S2 <- read.csv(config$explore_variants$analysis_3$input_trace_S2_table, sep = ";")
...
ggsave(paste0(config$explore_variants$output_plots_path,"/umaps_", patient,"/umap_107_variants.png"), plot = umap_custom, width = 11, height = 9, dpi = 300)
...
ggsave(paste0(config$explore_variants$output_plots_path,"/umap_all_cell_type_label.png"), plot = dimplot_all_post_label, width = 11, height = 9, dpi = 300)
config$explore_variants$output_plots_path
# ggsave(paste0(config$explore_variants$output_plots_path,"/umap_all_cell_type_label.svg"), plot = dimplot_all_post_label, width = 11, height = 9, dpi = 300) # error due to missing png.h library

svg(filename = config$explore_variants$output_plots_path,"/umap_all_cell_type_label.svg",
    width = 11,
    height = 9)
...
ggsave(paste0(config$explore_variants$output_plots_path,"/umap_all_variants_label.png"), plot = umap_variants_label, width = 11, height = 9, dpi = 300)

svg(filename = config$explore_variants$output_plots_path,"/umap_all_variants_label.svg",
    width = 11,
    height = 9)
...
ggsave(paste0(config$explore_variants$output_plots_path,"/umap_pre_vs_post_label.png"), plot = umap_label, width = 25, height = 15, dpi = 300)

svg(filename = config$explore_variants$output_plots_path,"/umap_pre_vs_post_label.svg",
    width = 25,
    height = 15)
print(umap_label)
dev.off()
...
ggsave(paste0(config$explore_variants$output_plots_path,"/sox9_umap_all.png"), plot = sox9_umap_all, width = 25, height = 15, dpi = 300)
ggsave(paste0(config$explore_variants$output_plots_path,"/sox9_umap_trazadas.png"), plot = sox9_umap_trazadas, width = 25, height = 15, dpi = 300)
ggsave(paste0(config$explore_variants$output_plots_path,"/sox9_vln_all.png"), plot = sox9_vln_all, width = 25, height = 15, dpi = 300)
ggsave(paste0(config$explore_variants$output_plots_path,"/sox9_vln_trazadas.png"), plot = sox9_vln_trazadas, width = 25, height = 15, dpi = 300)
...
ggsave(paste0(config$explore_variants$output_plots_path,"/actb_umap_all.png"), plot = actb_umap_all, width = 25, height = 15, dpi = 300)
ggsave(paste0(config$explore_variants$output_plots_path,"/actb_umap_trazadas.png"), plot = actb_umap_trazadas, width = 25, height = 15, dpi = 300)
ggsave(paste0(config$explore_variants$output_plots_path,"/actb_vln_all.png"), plot = actb_vln_all, width = 25, height = 15, dpi = 300)
ggsave(paste0(config$explore_variants$output_plots_path,"/actb_vln_trazadas.png"), plot = actb_vln_trazadas, width = 25, height = 15, dpi = 300)
#
